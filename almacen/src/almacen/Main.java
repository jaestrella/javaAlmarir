...
public class Main {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<10;i++){
            switch(i%2){
                case 0:
                    b=new AguaMineral("manantial1", 1, 5, 1.5, "bezoya");
                    a.agregarBebida(b);
                    break;
                case 1:
                    b=new BebidaAzucarada(0.2, true, 1, 6, 3, "Coca cola");
                    a.agregarBebida(b);
                    break;
            }
        }
		...
		System.out.println("Calcular el precio de la columna 0: "+a.calcularPrecioColumna(1));
	}
